...
class popOutImgPolice extends StatefulWidget {
  @override
  _popOutImgPoliceState createState() => _popOutImgPoliceState();
}

class _popOutImgPoliceState extends State<popOutImgPolice>
          ...
          children: [
            AnimatedBuilder(
              ...
              child: TextButton(
                ...
                child: Image.asset(
                  'lib/assets/page-1/images/police.png',
                  fit: BoxFit.contain,
                ),
              ),
            ),
